...
export default function Home() {
  return (
    <Layout>
      <div className='flex items-center flex-1 h-2/5  h-1/3'>
      ...
      <div>
        ...
        <div className='flex flex-col sm:flex-row justify-center gap-8 mb-36'>
          <Image
            src="/flecha.png"
            alt="flecha"
            layout="fixed"
        ...
        <div className='bg-regin_grey text-black p-8 sm:p-16'>
